...
class RealB1Driver:
    ...
    async def run(
        ...
        *,
        ...
        trust roots internally from governance; the approved identity is the EW1 successor
        ...
        try:
            ...
            #    internally and fails closed while the EW1 successor tag is ABSENT from Git.
