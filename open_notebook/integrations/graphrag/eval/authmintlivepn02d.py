...
#: HISTORICAL evidence of the B3X-R2 live-auth successor checkpoint. IMMUTABLE (tag object 935742f3,
#: peel 84346ce); it peeled to HEAD while B3X-R2 was the current live identity. The approved PN02D-B3X-R3A
#: lifecycle-state-invariance implementation checkpoint then advanced HEAD to c099384, so this tag is now
#: an ANCESTOR and is retained ONLY as historical provenance — it is NEVER the current governed B3
#: LIVE authorization identity (using it now fails closed under exact-HEAD trust, the stale-successor
